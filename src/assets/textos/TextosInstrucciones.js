...
export const instruccionesJuegoPosturas = [
    ...
    Al dar continuar, se preguntará aleatoriamente por una de las pausas activas, de clic sobre el signo (?) y seleccione la ubicación correcta según lo memorizado en la pantalla inicial. <br><br> 
    Cuando responda correctamente, será momento de realizar el ejercicio propuesto. Lea atentamente las instrucciones antes de continuar con el ejercicio. 
    `,
]
